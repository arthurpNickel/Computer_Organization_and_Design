...
; QUESTION: inicializar vetores no main?
; QUESTION: Colocar fim no meio é isso é gambiarra?
; QUESTION: Dá para fazer returns?
; QUESTION: Fazer função inicializadora antes de soma_vetor?
	; E colocar sub r3, r3
; QUESTION: Função de inicia iterador? Função de percorre? Dá?
; QUESTION: O uso do brzr está certo
...
main:	
	...
	ji soma_vetor	; ESSE JI TA MUITO ESTRANHO!!!!!!!!!!!!!!!
